# Mohammad Toufiq Maniyar Portfolio

This repository contains the source code for Mohammad Toufiq Maniyar's personal portfolio, built with React, TypeScript, animation-driven design, and responsive UI components. It highlights real projects, technical skills, experience, and a modern profile showcase.

Live site: [https://github.com/tpufiq-max](https://github.com/tpufiq-max)
